...
let package = Package(
    ...
    targets: [
        ...
        .executableTarget(name: "SwiftPlayground", dependencies: [.product(name: "Collections", package: "swift-collections")], swiftSettings: [.enableUpcomingFeature("StrictConcurrency")]),
        .testTarget(
